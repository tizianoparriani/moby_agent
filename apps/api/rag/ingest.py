...
from .metadata import DocMeta, enrich_date_from_text, enrich_legislature_from_text, enrich_title_from_text, meta_from_filename
...
def ingest_pdf(
    ...
    meta = enrich_legislature_from_text(first_pages_text, meta)
